using FactoryMethod.ExampleOne.Problem;
using FactoryMethod.ExampleOne.Solution;
using FactoryMethod.ExampleOne.Solution.FactoryMethods;
using FactoryMethod.ExampleOne.Solution.Interfaces;
using FactoryMethod.ExampleTwo.Problem;
using FactoryMethod.ExampleTwo.Solution;
using FactoryMethod.ExampleTwo.Solution.FactoryMethods;
