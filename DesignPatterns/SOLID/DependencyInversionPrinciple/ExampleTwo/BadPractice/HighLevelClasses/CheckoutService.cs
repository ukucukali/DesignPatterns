using DependencyInversionPrinciple.ExampleTwo.BadPractice.LowLevelClasses;

namespace DependencyInversionPrinciple.ExampleTwo.BadPractice.HighLevelClasses;
