using DependencyInversionPrinciple.ExampleOne.BadPractice.LowLevelClasses;

namespace DependencyInversionPrinciple.ExampleOne.BadPractice.HighLevelClasses;
